...
void Project2Test::test_MGFramework_setupDeleteSetupMO()
{
	...
	ASSERT_EQ(mgf.nthMO(0)->getTileX(), 1, "MGF failed to setup MO x");
	ASSERT_EQ(mgf.nthMO(0)->getTileY(), 1, "MGF failed to setup MO y");
	ASSERT_EQ(mgf.nthMO(0)->getOwner(), 1, "MGF failed to setup MO owner");

	ASSERT_EQ(mgf.nthMO(1)->getTileX(), 2, "MGF failed to setup MO x");
	ASSERT_EQ(mgf.nthMO(1)->getTileY(), 2, "MGF failed to setup MO y");
	ASSERT_EQ(mgf.nthMO(1)->getOwner(), 2, "MGF failed to setup MO owner");

	ASSERT_EQ(mgf.nthMO(2)->getTileX(), 3, "MGF failed to setup MO x");
	ASSERT_EQ(mgf.nthMO(2)->getTileY(), 3, "MGF failed to setup MO y");
	ASSERT_EQ(mgf.nthMO(2)->getOwner(), 3, "MGF failed to setup MO owner");

	ASSERT_EQ(mgf.nthMO(3)->getTileX(), 4, "MGF failed to setup MO x");
	ASSERT_EQ(mgf.nthMO(3)->getTileY(), 4, "MGF failed to setup MO y");
	ASSERT_EQ(mgf.nthMO(3)->getOwner(), 4, "MGF failed to setup MO owner");

	ASSERT_EQ(mgf.nthMO(4)->getTileX(), 5, "MGF failed to setup MO x");
	ASSERT_EQ(mgf.nthMO(4)->getTileY(), 5, "MGF failed to setup MO y");
	ASSERT_EQ(mgf.nthMO(4)->getOwner(), 5, "MGF failed to setup MO owner");

	// Trigger
	mgf._deleteMO(mgf.nthMO(2));
	ASSERT_EQ(mgf._getNumberOfMO(), 4, "MGF failed to delete MO");
	mgf._addMO(1);
	ASSERT_EQ(mgf._getNumberOfMO(), 5, "MGF failed to create MO");
	...
	ASSERT_EQ(mgf.nthMO(2)->getTileX(), 4, "MGF failed to setup MO x");
	ASSERT_EQ(mgf.nthMO(2)->getTileY(), 4, "MGF failed to setup MO y");
	ASSERT_EQ(mgf.nthMO(2)->getOwner(), 4, "MGF failed to setup MO owner");

	ASSERT_EQ(mgf.nthMO(3)->getTileX(), 5, "MGF failed to setup MO x");
	ASSERT_EQ(mgf.nthMO(3)->getTileY(), 5, "MGF failed to setup MO y");
	ASSERT_EQ(mgf.nthMO(3)->getOwner(), 5, "MGF failed to setup MO owner");

	ASSERT_EQ(mgf.nthMO(4)->getTileX(), 7, "MGF failed to setup MO x");
	ASSERT_EQ(mgf.nthMO(4)->getTileY(), 7, "MGF failed to setup MO y");
	ASSERT_EQ(mgf.nthMO(4)->getOwner(), 7, "MGF failed to setup MO owner");
}
